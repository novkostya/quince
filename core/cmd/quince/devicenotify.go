...
func (n deviceNotifications) SetNotificationsEnabled(udid string, enabled bool) (int, string) {
	...
	if err := n.store.SetDeviceNotificationsEnabled(udid, enabled); err != nil {
		...
		return http.StatusInternalServerError, "the preference could not be saved"
	}
