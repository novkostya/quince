...
**One-line state.** ⚑ **`qn.6b` "transport patience" is BUILT (CI-proven) ((df)) — awaiting the
architect's PR-CI land; then the CODE FREEZE + PROCESS REVAMP.** qn.6b = the patched-from-source
